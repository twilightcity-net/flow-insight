...
let imgParagraph = './assets/images/paragraph.png';

// render our component class
class App extends Component {
  render() {
    return (
      <Container style={{ marginTop: '2em' }}>
        <Header as='h1'>Theme Examples</Header>
        ...
        <p style={{ margin: '2em', textAlign: 'center' }}>
          <b>MetaOS</b> - Version: {version} - OpenMastery.org - Contact: <b><i>info@openmastery.org</i></b>
        </p>
      </Container>
    );
  }
