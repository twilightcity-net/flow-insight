...
/**
 * this component is the game wrapper for the initialization of the fervie adventure game
 * @copyright Twilight City, Inc. 2022©®™√
 */
export default class AdventureGame extends Component {
  /**
   * builds the adventure game content.
   * @param props
   */
  constructor(props) {
    super(props);
