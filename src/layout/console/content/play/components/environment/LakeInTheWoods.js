...
export default class LakeInTheWoods extends Environment {
  static GROUND_IMAGE =
    "./assets/animation/lake/fervie_lake_ground.png";
  static OVERLAY_IMAGE =
    "./assets/animation/lake/fervie_lake_overlay.png";
  static SKY_IMAGE =
    "./assets/animation/lake/fervie_lake_sky.png";
  static WALK_BEHIND_OVERLAY_IMAGE =
    "./assets/animation/lake/fervie_lake_trees.png";
  static WALK_AREA_IMAGE =
    "./assets/animation/lake/fervie_lake_walk_area.png";
  static WALK_BEHIND_AREA_IMAGE =
    "./assets/animation/lake/fervie_lake_walk_area_behind.png";
  ...
  preload(p5) {
    ...
    this.animationLoader.getStaticImage(
      p5,
      LakeInTheWoods.SKY_IMAGE
    );
    this.animationLoader.getStaticImage(
      p5,
      LakeInTheWoods.GROUND_IMAGE
    );
    this.animationLoader.getStaticImage(
      p5,
      LakeInTheWoods.OVERLAY_IMAGE
    );
    this.animationLoader.getStaticImage(
      p5,
      LakeInTheWoods.WALK_BEHIND_OVERLAY_IMAGE
    );
  ...
  drawBackground(p5, fervie) {
    ...
    let trees = this.animationLoader.getStaticImage(
      p5,
      LakeInTheWoods.WALK_BEHIND_OVERLAY_IMAGE
    );
