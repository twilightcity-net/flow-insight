...
export class RendererEventFactory {
  ...
  static get Events() {
    ...
    return {
      ...
      WINDOW_ACTIVE_STATUS_SHOW_HIDE: prefix + "window-active-status-show-hide",
      WINDOW_ACTIVE_STATUS_SHOWN: prefix + "window-active-status-shown",
      WINDOW_ACTIVE_STATUS_HIDDEN: prefix + "window-active-status-hidden",
