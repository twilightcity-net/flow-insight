...
export class RendererEventFactory {
  ...
  static get Events() {
    ...
    return {
      ...
      VIEW_CONSOLE_CIRCUIT_JOIN:
        "view-console-circuit-join",
      VIEW_CONSOLE_CIRCUIT_LEAVE:
        "view-console-circuit-leave",
