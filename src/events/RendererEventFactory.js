...
export class RendererEventFactory {
  ...
  static get Events() {
    ...
    return {
      ...
      VIEW_CONSOLE_SPIRIT_PANEL:
        prefix + "view-console-spirit-panel",
