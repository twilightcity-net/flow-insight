...
import {Icon, Image, Menu, Popup, Progress, Segment, Transition} from "semantic-ui-react";
...
export default class SpiritPanel extends Component {
    ...
    calculateSpiritHeight() {
        let spiritHeight = this.calculatePanelHeight() - 84;
        ...
        const spiritContent = (
            <div className="spiritContent">
                <div className="spiritBackground">
                    ...
                    <SpiritCanvas spirit={this.spiritModel} width={this.calculateSpiritWidth()}
                                  height={this.calculateSpiritHeight()}/>
