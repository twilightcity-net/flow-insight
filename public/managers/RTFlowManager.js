...
module.exports = class RTFlowManager {
    ...
    createConnection() {
        let url = global.App.rtFlowUrl +
            "?connectionId=" + global.App.connectionStatus.connectionId +
            "&memberId=" + global.App.connectionStatus.memberId +
            "&teamId=" + global.App.connectionStatus.teamId +
            "&organizationId=" + global.App.connectionStatus.organizationId;
