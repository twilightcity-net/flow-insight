...
/**
 * A small floating window for using an invitation key, which could be an invitation to an org, or a team.
 * Draggable around the screen, and detached from the console.
 * Can only open one windows of this type.
 */
module.exports = class InvitationKeyWindow {
  constructor(windowName, arg) {
    this.arg = arg;
    this.name = windowName;
    this.view = ViewManagerHelper.ViewNames.INVITATION;
  ...
  onShowCb() {
    log.info("[InvitationKeyWindow] opened window");
  }
